...
- VMWare Tanzu Postgres (or Bitnami postgres?)
- Bitnami Redis
- Azure Active Directory (?)
description: "Deploy Microservice Apps to TAP"
urlFragment: "acme-fitness-store"
---

# Deploy Spring Boot Apps to Tanzu Application Platform (TAP)

Tanzu Application Platform enables you to easily run Spring Boot and polyglot applications.

This quickstart shows you how to deploy existing applications written in Java, Python, and C# to TAP. 

* [Deploy Applications to Tanzu Application Platform (TAP)](#deploy-spring-boot-apps-to-tanzu-application-platform-(tap)
  ...
  * [Unit 3 - Integrate with PostgreSQL and Redis](#unit-3---integrate-with-azure-database-for-postgresql-and-azure-cache-for-redis)
...
* ? Deploy and Configure Application Configuration Service 
* ? Deploy polyglot applications to TAP and build using Tanzu Build Service
...
A kubernetes cluster running Tanzu Application Platform

In addition, you will need the following:

| [Tanzu CLI](...add reference...)
...
```shell
source ./tap/setup-env-variables.sh
```
# --- continue here 

### Deploy Spring Directory Services
### Deploy Spring Config Service
...
### Create a namespace for applications in TAP?
### or put them all in one namespace
### 
